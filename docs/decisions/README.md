...
- [ADR-003 Human Confirmation Is Required Before Submission](./ADR-003-human-confirmation-required.md)
...
- internal canonical temporal representation,
- and V2 memory/continuity boundaries.
